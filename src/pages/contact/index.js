                  ...
                  <div className="col-lg-6 col-sm-12 ">
                    <div className="right-col">
                      ...
                      <p className="grey-text">
                        Our team is fast to respond to messages. Get in touch
                        with us today!
                      </p>
                      <div className="contact-details m-top">
                        ...
                        <div className="phone-no">
                          <span>+234 8165236384 </span> <br />
                          <span>+234 7052216734</span>
                        </div>
                      </div>
                      <div className="contact-details m-top">
                        <div className="icon">
                          <i className="fa fa-firefox icon"></i>
                        </div>
                        <div className="phone-no">
                          <span>kingdomhelps.com</span>
                        </div>
                      </div>
